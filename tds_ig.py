...
#đánh dấu bản quyền
ndp_tool="\033[1;37m~[\033[1;31m+\033[1;37m] \033[1;37m=> "
thanh = "\033[1;37m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ="
#Config
__VERSION__ = '9.6'
def banner():
...
\033[1;37m   ╚═╝   ╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝    ╚═════╝ ╚══════╝  ╚═══╝  
\033[1;37m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
{ndp_tool}\033[1;35mTOOL TRAODOISUB INSTAGRAM VERSION {__VERSION__}
{ndp_tool}\033[1;32mBản Quyền: \033[1;33mThoai Dev
{ndp_tool}\033[1;36mZalo Admin: \033[1;31mĐang Update
\033[1;37m= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
"""
# ======================== [ HOME TOOL ] ======================== 
...
def delay_ndp(o):
	while (o>1):
		o=o-1
		print(luc+' Tiếp Tục Sau <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(do+' Tiếp Tục Sau <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(vang+' Tiếp Tục Sau <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(hong+' Tiếp Tục Sau <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(xnhac+' Tiếp Tục Sau <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
def loadjob(o):
	while (o>1):
		o=o-1
		print(luc+' Đang Tìm Nhiệm Vụ <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(do+' Đang Tìm Nhiệm Vụ <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(vang+' Đang Tìm Nhiệm Vụ <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
		print(hong+' Đang Tìm Nhiệm Vụ <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.1)
		print(xnhac+' Đang Tìm Nhiệm Vụ <~>Thoai Dev '+do+'| '+vang+''+str(o)+do+' |','      ', end='\r')
		sleep(0.2)
